...
The `cloudflared` binary is auto-downloaded, platform-matched, and version-locked on first use. Stored in `node_modules/.cache/tunnel-sdk/bin/`.
...
```ts
import { createDefaultTunnelDeps } from "tunnel-sdk"
