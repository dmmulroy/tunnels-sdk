...
2. **Zero-config quick path** — `cft expose 3000` / `expose(3000)` gets you a URL with nothing else.
...
- **Noun-verb pattern** — `cft tunnel create`, `cft route add`. Flat where possible.
